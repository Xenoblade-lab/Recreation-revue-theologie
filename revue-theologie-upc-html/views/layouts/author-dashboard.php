...
<body class="dashboard-layout min-h-screen flex flex-col">
  <div class="dashboard-topbar">
    <div class="flex items-center gap-4">
      ...
      <span class="text-sm font-medium">Espace Auteur</span>
    </div>
    <div class="breadcrumb">
      <a href="<?= $base ?>/">Accueil</a>
      <a href="<?= $base ?>/author">Dashboard</a>
      <a href="<?= $base ?>/author/abonnement" class="text-primary">Abonnement</a>
      <a href="<?= $base ?>/author/notifications" class="text-primary">Notifications</a>
  ...
  <div class="dashboard-body">
    <aside class="dashboard-sidebar" id="dashboard-sidebar">
      <div class="sidebar-inner">
        <p class="sidebar-title">Espace auteur</p>
        <nav>
  ...
  <footer class="site-footer" style="padding-top: 1.5rem; padding-bottom: 1.5rem;">
    <div class="container">
      <div class="footer-bottom">
        <p class="mb-0">&copy; <span id="year"></span> Revue de la Faculté de Théologie - UPC. Espace auteur.</p>
