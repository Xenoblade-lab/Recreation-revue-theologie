...
<div class="banner">
  <div class="container">
    <h1 class="font-serif text-3xl md:text-4xl font-bold text-balance"><?= htmlspecialchars(__('presentation.title')) ?></h1>
    <div class="divider"></div>
    <p><?= htmlspecialchars(__('presentation.intro')) ?></p>
  </div>
</div>
<section class="container presentation-intro">
  <div>
    <h2 class="font-serif text-2xl md:text-3xl font-bold mb-6 text-balance"><?= htmlspecialchars(__('presentation.tradition')) ?></h2>
    <?php if ($desc): ?>
    ...
    <p class="text-muted leading-relaxed mt-4"><?= htmlspecialchars(__('presentation.desc_default_2')) ?></p>
    <?php endif; ?>
...
<section class="section bg-secondary">
  <div class="container">
    <div class="grid-3" style="grid-template-columns: repeat(4, 1fr);">
      <div class="text-center"><p class="text-3xl font-bold text-primary mb-0">65+</p><p class="text-sm text-muted mt-1"><?= htmlspecialchars(__('presentation.years')) ?></p></div>
      <div class="text-center"><p class="text-3xl font-bold text-primary mb-0">200+</p><p class="text-sm text-muted mt-1"><?= htmlspecialchars(__('presentation.articles_published')) ?></p></div>
      <div class="text-center"><p class="text-3xl font-bold text-primary mb-0">150+</p><p class="text-sm text-muted mt-1"><?= htmlspecialchars(__('presentation.contributors')) ?></p></div>
      <div class="text-center"><p class="text-3xl font-bold text-primary mb-0">12+</p><p class="text-sm text-muted mt-1"><?= htmlspecialchars(__('presentation.countries')) ?></p></div>
    </div>
  </div>
</section>
<section class="container section">
  <h2 class="font-serif text-2xl md:text-3xl font-bold text-center mb-2"><?= htmlspecialchars(__('presentation.objectives')) ?></h2>
...
<section class="section bg-primary">
  <div class="container">
    <h2 class="font-serif text-2xl md:text-3xl font-bold text-center mb-2" style="color: var(--primary-foreground);"><?= htmlspecialchars(__('presentation.domains')) ?></h2>
    ...
    <div class="grid-3 gap-6">
      <div class="card" style="background: rgba(255,255,255,0.1); border-color: rgba(255,255,255,0.2);"><h3 class="font-serif font-bold mb-2" style="color: var(--primary-foreground);"><?= htmlspecialchars(__('presentation.domain_biblical')) ?></h3><p class="text-sm leading-relaxed mb-0" style="color: rgba(255,255,255,0.7);"><?= htmlspecialchars(__('presentation.domain_biblical_desc')) ?></p></div>
      <div class="card" style="background: rgba(255,255,255,0.1); border-color: rgba(255,255,255,0.2);"><h3 class="font-serif font-bold mb-2" style="color: var(--primary-foreground);"><?= htmlspecialchars(__('presentation.domain_systematic')) ?></h3><p class="text-sm leading-relaxed mb-0" style="color: rgba(255,255,255,0.7);"><?= htmlspecialchars(__('presentation.domain_systematic_desc')) ?></p></div>
      <div class="card" style="background: rgba(255,255,255,0.1); border-color: rgba(255,255,255,0.2);"><h3 class="font-serif font-bold mb-2" style="color: var(--primary-foreground);"><?= htmlspecialchars(__('presentation.domain_ethics')) ?></h3><p class="text-sm leading-relaxed mb-0" style="color: rgba(255,255,255,0.7);"><?= htmlspecialchars(__('presentation.domain_ethics_desc')) ?></p></div>
      <div class="card" style="background: rgba(255,255,255,0.1); border-color: rgba(255,255,255,0.2);"><h3 class="font-serif font-bold mb-2" style="color: var(--primary-foreground);"><?= htmlspecialchars(__('presentation.domain_history')) ?></h3><p class="text-sm leading-relaxed mb-0" style="color: rgba(255,255,255,0.7);"><?= htmlspecialchars(__('presentation.domain_history_desc')) ?></p></div>
      <div class="card" style="background: rgba(255,255,255,0.1); border-color: rgba(255,255,255,0.2);"><h3 class="font-serif font-bold mb-2" style="color: var(--primary-foreground);"><?= htmlspecialchars(__('presentation.domain_practical')) ?></h3><p class="text-sm leading-relaxed mb-0" style="color: rgba(255,255,255,0.7);"><?= htmlspecialchars(__('presentation.domain_practical_desc')) ?></p></div>
    </div>
    <?php endif; ?>
  </div>
</section>
<section class="container section">
  <h2 class="font-serif text-2xl md:text-3xl font-bold text-center mb-2"><?= htmlspecialchars(__('presentation.instructions_link')) ?></h2>
  <div class="divider center"></div>
