...
Router::get('/admin/users/[i:id]', [AdminController::class, 'userDetail']);
Router::post('/admin/users/[i:id]/edit', [AdminController::class, 'userUpdate']);
Router::post('/admin/users/[i:id]/delete', [AdminController::class, 'userDelete']);
Router::get('/admin/articles', [AdminController::class, 'articles']);
Router::get('/admin/evaluations', [AdminController::class, 'evaluations']);
Router::post('/admin/evaluation/[i:id]/unassign', [AdminController::class, 'evaluationUnassign']);
...
Router::post('/admin/article/[i:id]/delete', [AdminController::class, 'articleDelete']);
...
Router::get('/admin/volumes/create', [AdminController::class, 'volumeCreate']);
Router::post('/admin/volumes', [AdminController::class, 'volumeStore']);
...
Router::get('/admin/numeros/create', [AdminController::class, 'numeroCreate']);
Router::post('/admin/numeros', [AdminController::class, 'numeroStore']);
